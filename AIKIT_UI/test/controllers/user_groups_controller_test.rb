...
class UserGroupsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_group" do
    assert_difference("UserGroup.count") do
      post user_groups_url, params: { user_group: { group_id: @user_group.group_id, role: @user_group.role, user_id: @user_group.user_id } }
    end
  ...
  test "should update user_group" do
    patch user_group_url(@user_group), params: { user_group: { group_id: @user_group.group_id, role: @user_group.role, user_id: @user_group.user_id } }
