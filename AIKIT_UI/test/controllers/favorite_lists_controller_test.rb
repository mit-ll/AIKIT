...
class FavoriteListsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create favorite_list" do
    assert_difference("FavoriteList.count") do
      post favorite_lists_url, params: { favorite_list: { folder_id: @favorite_list.folder_id, is_private: @favorite_list.is_private, is_public: @favorite_list.is_public, list_name: @favorite_list.list_name, user_id: @favorite_list.user_id } }
    end
  ...
  test "should update favorite_list" do
    patch favorite_list_url(@favorite_list), params: { favorite_list: { folder_id: @favorite_list.folder_id, is_private: @favorite_list.is_private, is_public: @favorite_list.is_public, list_name: @favorite_list.list_name, user_id: @favorite_list.user_id } }
